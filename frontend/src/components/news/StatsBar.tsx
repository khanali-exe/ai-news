...
export function StatsBar() {
  ...
  return (
    <div
      className="glass mb-8 flex flex-wrap items-center gap-x-6 gap-y-3 rounded-2xl px-5 py-4 relative overflow-hidden"
    >
      ...
      <div className="ml-auto hidden items-center gap-2 sm:flex">
        <span className="glow-pulse h-1.5 w-1.5 rounded-full bg-emerald-400 text-emerald-400" />
